                                ...
                                <select name="client_id" id="client-select" class="form-control" style="width: 100%; appearance: none; padding-right: 30px;" onchange="updateClientLimitInfo()">
                                        ...
                                        <?php foreach($clients as $client): ?>
                                            <option
                                                ...
                                                data-limit="<?php echo $client->getLimiteCredit(); ?>"
                                            >
                                              <?php echo $client->getNom().' '.$client->getPrenom().' ('.$client->getTelephone().')'; ?>
                                            </option>
                                        <?php endforeach; ?>  
                                </select>
                        ...
                        <div style="border-top: 1px dashed var(--border-color); padding-top: 16px; margin-top: 16px; margin-bottom: 16px;">
                            ...
                            <div style="display: grid; grid-template-columns: 2.2fr 0.8fr auto; gap: 8px; align-items: flex-end; margin-bottom: 16px;">
                                <div class="form-group" style="margin-bottom: 0;">
                                    ...
                                    <select id="pos-item-select" name ="produit_id" class="form-control" style="background-color: #0b0f1a; color: white; padding: 10px; font-size: 12px;">

                                        <option value="" selected disabled>-- Sélectionner un produit --</option>
                                        <?php foreach($produits as $produit): ?>
                                            <option
                                                value="<?php echo $produit->getId(); ?>"
                                                data-price="<?php echo $produit->getPrixVente(); ?>"
                                                data-name="<?php echo $produit->getNom(); ?>"
                                                data-stock="<?php echo $produit->getQuantiteStock(); ?>"
                                            >
                                                🟢 <?php echo $produit->getNom(); ?>
                                                (<?php echo $produit->getQuantiteStock(); ?>)
                                            </option>
                                        <?php endforeach; ?>  
                                    </select>
                                </div>
                    ...
                    <table class="debt-table" id="debts-main-table">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($dettes as $dette): ?>
                                ...
                                <tr
                                    class="dette"
                                    id="debt-row-<?php echo $dette['id']; ?>"
                                    data-client="<?php echo $dette['prenom'].' '.$dette['nom']; ?>"
                                >

                                    <td>
                                        <strong>#DT-<?php echo $dette['id']; ?></strong>
                                        ...
                                        <span style="
                                            ...
                                            margin-top:3px;
                                        ">
                                            #CMD-<?php echo $dette['commande_id']; ?>
                                        </span>
                                    </td>

                                    <td>
                                        <?php echo $dette['date_commande']; ?>
                                    </td>

                                    <td>
                                        <strong>
                                            <?php echo $dette['prenom'].' '.$dette['nom']; ?>
                                        </strong>
                                        ...
                                        <span style="
                                            ...
                                            margin-top:3px;
                                        ">
                                            Tél : <?php echo $dette['telephone']; ?>
                                        </span>
                                    </td>

                                    <td>
                                        <?php echo $dette['montant_initial']; ?> F
                                    </td>

                                    <td style="color:var(--success); font-weight:700;">
                                        <?php echo $dette['montant_paye']; ?>F
                                    </td>

                                    <td style="color:var(--danger); font-weight:800;">
                                           <?php echo $dette['montant_restant']; ?> F
                                    </td>

                                    <td>

                                        <span class="badge <?php echo $dette['statut'] == 'SOLDEE' ? 'payee' : 'non-payee'; ?>">
                                        ...
                                        <?php if ($dette['statut'] != 'SOLDEE'): ?>
                                            ...
                                            <button
                                                ...
                                                style="
                                                    ...
                                                    color:var(--warning);
                                                "
                                                onclick="toggleDetails('debt-repay-<?php echo $dette['id']; ?>')"
                                            >
                                                Rembourser
                                            </button>
                                    ...
                                    <tr>
                                        ...
                                        >
                                            ...
                                            <div
                                                ...
                                                id="debt-repay-<?php echo $dette['id']; ?>"
                                            >
                                                ...
                                                >
                                                    ...
                                                    <div style="flex:1; min-width:200px;">
                                                        ...
                                                        <input
                                                            ...
                                                            name="montant"
                                                            class="form-control"
                                                            value="<?php echo $dette['montant_restant'] ?>"
                                                            min="1"
                                                            max="<?php echo $dette['montant_restant']?>"
                                                            required
                                                        >
